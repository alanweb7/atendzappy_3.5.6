...
const TicketActionButtonsCustom = ({ ticket }) => {
    ...
    const shouldShowCloseModal = isEvaluationEnabled;
            ...
            >
                <div style={{ padding: "24px 28px 8px" }}>
                    <div style={{ fontWeight: 600, fontSize: 16, marginBottom: 8 }}>
                        Deseja enviar avaliação?
                    </div>
                    <div style={{ color: "#757575", fontSize: 14 }}>
                        Ao fechar o atendimento, o cliente pode receber uma mensagem de avaliação.
                    </div>
                </div>
                <DialogActions style={{ padding: "12px 20px 16px", gap: 8 }}>
                    <Button
