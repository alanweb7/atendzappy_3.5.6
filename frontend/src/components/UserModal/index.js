              ...
              <DialogContent dividers className={classes.dialogContent}>
                ...
                {!(isSelfEditing && (values.userType === "attendant" || values.userType === "professional")) && (
                  ...
                  >
                        ...
                        yes={() => (
                          <>
                            <Grid container spacing={2}>
                              ...
                              {/* Acesso ao Marketing — liberar para atendente/profissional */}
                              {(values.userType === "attendant" || values.userType === "professional") && (
                                <Grid item xs={12} sm={6} md={4}>
                                  <FormControl variant="outlined" margin="dense" fullWidth className={classes.selectField}>
                                    <InputLabel>Acesso ao Marketing</InputLabel>
                                    <Field as={Select} label="Acesso ao Marketing" name="canAccessMarketing">
                                      <MenuItem value={false}>Desabilitado</MenuItem>
                                      <MenuItem value={true}>Habilitado</MenuItem>
                                    </Field>
                                  </FormControl>
                    ...
                    {/* Acesso Suporte — apenas empresa 1 pode conceder */}
                    {loggedInUser.companyId === 1 && (
                      <Paper elevation={0} className={classes.card}>
                        <Typography className={classes.sectionTitle}>
                          <BuildIcon fontSize="small" /> Acesso a Outras Empresas
                        </Typography>
                        <Typography variant="body2" color="textSecondary" style={{ marginBottom: 12 }}>
                          Permite que este usuário acesse outras empresas no modo suporte sem precisar de senha.
                        </Typography>
                        <Grid container spacing={2}>
                          <Grid item xs={12} sm={6} md={4}>
                            <FormControl variant="outlined" margin="dense" fullWidth className={classes.selectField}>
                              <InputLabel>Acesso a Empresas</InputLabel>
                              <Field
                                as={Select}
