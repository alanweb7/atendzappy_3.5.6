      ...
      return (
        ...
        return (
          <div style={{ position: "relative", display: "inline-block" }}>
            ...
            {message.loading && (
              <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.4)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", borderRadius: 8, gap: 4 }}>
                <CircularProgress size={24} style={{ color: "#fff" }} />
                <span style={{ color: "#fff", fontSize: 11 }}>Enviando...</span>
              </div>
            )}
          </div>
        );
        ...
        if (message.mediaType === "audio") {
          return (
            <div style={{ position: "relative" }}>
              ...
              {message.loading && (
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 4, color: "#888", fontSize: 11 }}>
            ...
            return (
              <div style={{ position: "relative" }}>
                <video
                  ...
                  style={{ opacity: message.loading ? 0.5 : 1 }}
                />
                {message.loading && (
                  <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.4)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", borderRadius: 8, gap: 6 }}>
                    <CircularProgress size={32} style={{ color: "#fff" }} />
                    <span style={{ color: "#fff", fontSize: 12, fontWeight: 600 }}>Enviando vídeo...</span>
                  </div>
                )}
              </div>
            );
