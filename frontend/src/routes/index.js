...
import ConversasRelatorio from "../pages/ConversasRelatorio";
import RelatorioAtendentes from "../pages/RelatorioAtendentes";
import RelatorioTags from "../pages/RelatorioTags";
import RelatorioTagsKanban from "../pages/RelatorioTagsKanban";
...
import GoogleMyNegocio from "../pages/Marketing/GoogleMyNegocio";
...
import CreditosIA from "../pages/CreditosIA";
import AdminCreditosIA from "../pages/AdminCreditosIA";
          ...
          <PlanPermissionsProvider>
            ...
            <WhatsAppsProvider>
              ...
              <LoggedInLayout>
                ...
                <ProtectedRoute exact path="/fiscal" component={Fiscal} />
                <ProtectedRoute exact path="/planilhas" component={Planilhas} />
                ...
                <ProtectedRoute exact path="/creditos-ia" component={CreditosIA} />
                <ProtectedRoute exact path="/admin/creditos-ia" component={AdminCreditosIA} />
                ...
                <ProtectedRoute exact path="/relatorios/conversas" component={ConversasRelatorio} />
                <ProtectedRoute exact path="/relatorios/atendentes" component={RelatorioAtendentes} />
                <ProtectedRoute exact path="/relatorios/tags" component={RelatorioTags} />
                <ProtectedRoute exact path="/relatorios/kanban" component={RelatorioTagsKanban} />
                <ProtectedRoute exact path="/relatorios/faturas" component={RelatorioFaturas} />
                <ProtectedRoute exact path="/tarefas" component={Tarefas} />
                <ProtectedRoute exact path="/email-inbox" component={EmailInbox} />
                ...
                <ProtectedRoute exact path="/contas" component={ContasFinanceiras} />
                ...
                <ProtectedRoute exact path="/marketing/google-meu-negocio" component={GoogleMyNegocio} />
                <ProtectedRoute exact path="/marketing/meta-ads" component={MetaAds} />
                <ProtectedRoute exact path="/marketing/google-ads" component={GoogleAds} />
