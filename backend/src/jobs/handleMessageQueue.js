...
exports["default"] = {
    key: "".concat(process.env.DB_NAME, "-handleMessage"),
    handle: function (_a) {
        var data = _a.data;
        return __awaiter(this, void 0, void 0, function () {
            var message, wbot, companyId, w, error_1, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, , 6]);
                        message = data.message, wbot = data.wbot, companyId = data.companyId;
                        if (message === undefined || wbot === undefined || companyId === undefined) {
                            console.log("message, wbot, companyId", message, wbot, companyId);
                        }
                        w = (0, wbot_1.getWbot)(wbot);
                        if (!w) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (0, wbotMessageListener_1.handleMessage)(message, w, companyId)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 3:
