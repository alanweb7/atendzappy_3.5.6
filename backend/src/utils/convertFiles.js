...
var deleteFile = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, promises_1.rm)(path)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var convertToMp3 = function (media) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                var outputFilePath = "".concat(media.path
                    .split(".")
                    .slice(0, -1)
                    .join("."), ".mp3");
                (0, fluent_ffmpeg_1["default"])(media.path)
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, deleteFile(media.path)];
                            case 1:
                                _a.sent();
...
var convertToMp4 = function (media) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                var outputFilePath = "".concat(media.path
                    .split(".")
