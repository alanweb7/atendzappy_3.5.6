...
module.exports = {
    up: function (queryInterface) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, queryInterface.rawSelect('CompaniesSettings', {
                        where: {
                            companyId: 1
                        }
                    }, ['companyId'])];
                case 1:
                    settingsExist = _a.sent();
                    if (!settingsExist) {
                        return [2 /*return*/, queryInterface.bulkInsert("CompaniesSettings", [
                                {
                                    companyId: 1,
    ...
    down: function (queryInterface) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, queryInterface.bulkDelete("CompaniesSettings", { companyId: 1 })];
        });
    }); }
};
