...
module.exports = {
    up: function (queryInterface) { return __awaiter(void 0, void 0, void 0, function () {
        var settings, _i, settings_1, setting, exists;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, queryInterface.rawSelect("Settings", {
                            where: __assign({ key: setting.key }, (setting.companyId && { companyId: setting.companyId }))
                        }, ["id"])];
                case 2:
                    exists = _a.sent();
                    if (!!exists) return [3 /*break*/, 4];
                    return [4 /*yield*/, queryInterface.bulkInsert("Settings", [
                            __assign(__assign({}, setting), { createdAt: new Date(), updatedAt: new Date() })
                        ], {})];
                case 3:
                    _a.sent();
                    _a.label = 4;
    ...
    down: function (queryInterface) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, queryInterface.bulkDelete("Settings", null, {})];
        });
    }); }
};
