...
var updateUser = function (userId, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var user, update, io;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!!user.online) return [3 /*break*/, 4];
                // console.log("updateUser", user.online, update)
                update = __assign(__assign({}, update), { online: true });
            ...
            case 3:
                ...
                io.of(String(companyId))
                    .emit("company-".concat(user.companyId, "-user"), {
                    action: "update",
                    user: user
                });
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, user.update(update)];
            case 5:
                _a.sent();
                _a.label = 6;
