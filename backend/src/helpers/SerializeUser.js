...
var SerializeUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var generateToken;
    return __generator(this, function (_a) {
        generateToken = function (userId) {
            // Gerar o token com base no userId e sua chave secreta
            var token = jsonwebtoken_1["default"].sign({ userId: userId }, process.env.JWT_SECRET, { expiresIn: "1h" }); // Você pode definir o tempo de expiração conforme necessário
            return token;
        };
        return [2 /*return*/, {
                id: user.id,
                ...
                userType: user.userType || "attendant"
            }];
    });
}); };
