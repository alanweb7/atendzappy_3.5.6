...
var CheckSettings = function (key) { return __awaiter(void 0, void 0, void 0, function () {
    var setting;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Setting_1["default"].findOne({
                    where: { key: key }
                })];
            case 1:
                setting = _a.sent();
...
var CheckSettings1 = function (key, defaultValue) {
...
var CheckCompanySetting = function (companyId, key, defaultValue) {
    if (defaultValue === void 0) { defaultValue = null; }
    return __awaiter(void 0, void 0, void 0, function () {
        var setting;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (setting === null || setting === void 0 ? void 0 : setting.value) || defaultValue];
            }
        });
    });
};
