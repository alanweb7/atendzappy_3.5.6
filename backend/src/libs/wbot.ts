        ...
        wsocket.ev.on(
          ...
          async ({ connection, lastDisconnect, qr }) => {
            ...
            if (connection === "close") {
              ...
              // 403 = banido/desautorizado — limpa sessão, NÃO reconecta
              if (statusCode === 403) {
              ...
              // Não reconecta se a sessão foi intencionalmente parada (ex: max QR atingido)
              const freshWhatsapp = await whatsapp.reload();
