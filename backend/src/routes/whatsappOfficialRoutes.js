...
var WhatsAppOfficialController = __importStar(require("../controllers/WhatsAppOfficialController"));
var uploadMediaAttachment_1 = require("../services/WhatsAppOfficial/uploadMediaAttachment");
var whatsappOfficialRoutes = express_1["default"].Router();
var upload = (0, multer_1["default"])(upload_1["default"]);
// CRUD da conexão oficial
whatsappOfficialRoutes.get("/whatsapp-official/:whatsappId", isAuth_1["default"], WhatsAppOfficialController.showOfficial);
...
// Templates da Meta
whatsappOfficialRoutes.get("/whatsapp-official/:whatsappId/templates", isAuth_1["default"], WhatsAppOfficialController.listTemplates);
// Verificar status real da conexão
whatsappOfficialRoutes.get("/whatsapp-official/:id/check-status", isAuth_1["default"], WhatsAppOfficialController.checkStatus);
