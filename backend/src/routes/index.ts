...
import externalProductCategoryRoutes from "./api/externalProductCategoryRoutes";
...
import aiCreditsRoutes from "./aiCreditsRoutes";
...
import aiIntegrationRoutes from "./aiIntegrationRoutes";
import taskRoutes from "./taskRoutes";
import emailAccountRoutes from "./emailAccountRoutes";
...
routes.use("/api/external", externalProductCategoryRoutes);
...
routes.use(aiIntegrationRoutes);
routes.use(taskRoutes);
routes.use(emailAccountRoutes);
...
// Google Meu Negócio
routes.use(googleBusinessRoutes);
