...
var CampaignController = __importStar(require("../controllers/CampaignController"));
...
routes.post("/campaigns/:id/template-media", isAuth_1["default"], upload.array("file"), CampaignController.templateMediaUpload);
routes["delete"]("/campaigns/:id/template-media", isAuth_1["default"], CampaignController.deleteTemplateMedia);
