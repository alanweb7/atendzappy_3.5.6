...
var TicketNoteController = __importStar(require("../controllers/TicketNoteController"));
...
ticketNoteRoutes.get("/ticket-notes/reminders", isAuth_1["default"], TicketNoteController.reminders);
ticketNoteRoutes.put("/ticket-notes/:id/done", isAuth_1["default"], TicketNoteController.doneReminder);
