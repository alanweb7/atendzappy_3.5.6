...
ticketNoteRoutes.get("/ticket-notes/reminders", isAuth, TicketNoteController.reminders);
ticketNoteRoutes.put("/ticket-notes/:id/done", isAuth, TicketNoteController.doneReminder);
