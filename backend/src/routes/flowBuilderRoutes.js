...
var uploadExt_1 = __importDefault(require("../config/uploadExt"));
var FlowBuilderController = __importStar(require("../controllers/FlowBuilderController"));
var upload = (0, multer_1["default"])(uploadExt_1["default"]);
var flowBuilder = express_1["default"].Router();
