...
var CompanyController = __importStar(require("../../controllers/api/CompanyController"));
var PlanController = __importStar(require("../../controllers/api/PlanController"));
var HelpController = __importStar(require("../../controllers/api/HelpController"));
var PartnerController = __importStar(require("../../controllers/api/PartnerController"));
var GooglePlacesController = __importStar(require("../../controllers/api/GooglePlacesController"));
var InvoicesController = __importStar(require("../../controllers/InvoicesController"));
var UserController = __importStar(require("../../controllers/UserController"));
var isAuthCompany_1 = __importDefault(require("../../middleware/isAuthCompany"));
var apiCompanyRoutes = express_1["default"].Router();
// PLANS
