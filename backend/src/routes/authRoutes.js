...
var SessionController = __importStar(require("../controllers/SessionController"));
var UserController = __importStar(require("../controllers/UserController"));
var MobileAuthController = __importStar(require("../controllers/MobileAuthController"));
...
authRoutes.get("/check-first-signup", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyCount, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Company_1["default"].count()];
            case 1:
                companyCount = _a.sent();
                return [2 /*return*/, res.json({ isFirstSignup: companyCount === 0 })];
            case 2:
                error_1 = _a.sent();
                return [2 /*return*/, res.json({ isFirstSignup: false })];
...
authRoutes.post("/impersonate", isAuth_1["default"], SessionController.impersonate);
authRoutes.post("/exit-impersonate", SessionController.exitImpersonate);
