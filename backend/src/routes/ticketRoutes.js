...
var TicketController = __importStar(require("../controllers/TicketController"));
...
ticketRoutes.get("/tickets-tag-history/:ticketId", isAuth_1["default"], TicketController.tagHistory);
