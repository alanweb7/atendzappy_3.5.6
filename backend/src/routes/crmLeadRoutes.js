...
var CrmLeadController = __importStar(require("../controllers/CrmLeadController"));
var upload = (0, multer_1["default"])(upload_1["default"]);
var crmLeadRoutes = (0, express_1.Router)();
...
crmLeadRoutes.get("/crm/leads/export", isAuth_1["default"], CrmLeadController.exportLeads);
crmLeadRoutes.post("/crm/leads/export", isAuth_1["default"], CrmLeadController.exportLeads);
crmLeadRoutes.post("/crm/leads/import", isAuth_1["default"], upload.single('file'), CrmLeadController.importLeads);
