...
var ScheduleController = __importStar(require("../controllers/ScheduleController"));
...
scheduleRoutes.post("/schedules/bulk", isAuth_1["default"], ScheduleController.storeBulk);
