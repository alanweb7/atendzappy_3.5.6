...
var ListService_1 = __importDefault(require("../services/AnnouncementService/ListService"));
var CreateService_1 = __importDefault(require("../services/AnnouncementService/CreateService"));
var ShowService_1 = __importDefault(require("../services/AnnouncementService/ShowService"));
var UpdateService_1 = __importDefault(require("../services/AnnouncementService/UpdateService"));
var DeleteService_1 = __importDefault(require("../services/AnnouncementService/DeleteService"));
var FindService_1 = __importDefault(require("../services/AnnouncementService/FindService"));
...
var mediaUpload = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, companyId, files, file, announcement, io, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
...
var deleteMedia = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, companyId, announcement, filePath, fileExists, io, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
            ...
            case 2:
                announcement = _a.sent();
                filePath = path_1["default"].resolve("public", "announcements", announcement.mediaPath);
