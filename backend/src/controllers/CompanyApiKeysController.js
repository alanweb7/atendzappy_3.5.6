...
var generateApiToken_1 = __importDefault(require("../utils/generateApiToken"));
var upsertSchema = Yup.object().shape({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, CompanyApiKey_1["default"].findAll({
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, payload, token, record;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                companyId = req.user.companyId;
                return [4 /*yield*/, upsertSchema.validate(req.body)];
            case 1:
                payload = _a.sent();
                token = (0, generateApiToken_1["default"])();
                return [4 /*yield*/, CompanyApiKey_1["default"].create({
                        companyId: companyId,
                        label: payload.label,
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, id, payload, record;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                companyId = req.user.companyId;
            ...
            case 1:
                payload = _a.sent();
                return [4 /*yield*/, CompanyApiKey_1["default"].findOne({
