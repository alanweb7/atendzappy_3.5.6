...
var ListService_1 = __importDefault(require("../services/ContactListService/ListService"));
var CreateService_1 = __importDefault(require("../services/ContactListService/CreateService"));
var ShowService_1 = __importDefault(require("../services/ContactListService/ShowService"));
var UpdateService_1 = __importDefault(require("../services/ContactListService/UpdateService"));
var DeleteService_1 = __importDefault(require("../services/ContactListService/DeleteService"));
var FindService_1 = __importDefault(require("../services/ContactListService/FindService"));
var lodash_1 = require("lodash");
var AppError_1 = __importDefault(require("../errors/AppError"));
var ImportContacts_1 = require("../services/ContactListService/ImportContacts");
        ...
        switch (_a.label) {
            ...
            case 5:
                ...
                io.of(String(companyId))
                    .emit("company-".concat(companyId, "-ContactList"), {
                    action: "create",
                    record: record
                });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.status(200).json({ message: "Contact list deleted" })];
        }
    });
}); };
...
var upload = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var files, file, id, companyId, response, io;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                files = req.files;
                ...
                id = req.params.id;
                companyId = req.user.companyId;
                return [4 /*yield*/, (0, ImportContacts_1.ImportContacts)(+id, companyId, file)];
            case 1:
                response = _a.sent();
                io = (0, socket_1.getIO)();
                io.of(String(companyId))
                    .emit("company-".concat(companyId, "-ContactListItem-").concat(+id), {
                    action: "reload",
                    records: response
                });
