...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, _a, searchParam, status, type, ownerUserId, pageNumber, limit, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                companyId = ensureExternalAuth(req).companyId;
                _a = req.query, searchParam = _a.searchParam, status = _a.status, type = _a.type, ownerUserId = _a.ownerUserId, pageNumber = _a.pageNumber, limit = _a.limit;
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var externalAuth, data, client;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                externalAuth = ensureExternalAuth(req);
                data = req.body;
                return [4 /*yield*/, (0, CreateCrmClientService_1["default"])(__assign(__assign({}, data), { companyId: externalAuth.companyId }))];
            case 1:
                client = _a.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var externalAuth, id, data, client;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                externalAuth = ensureExternalAuth(req);
                id = req.params.id;
                data = req.body;
                return [4 /*yield*/, (0, UpdateCrmClientService_1["default"])(__assign({ id: Number(id), companyId: externalAuth.companyId }, data))];
            case 1:
                client = _a.sent();
                return [4 /*yield*/, (0, triggerExternalWebhook_1["default"])({
                        url: externalAuth.webhookUrl,
