...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, _a, pageNumber, searchParam, limit, offset, whereCondition, _b, count, tags, hasMore;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                whereCondition = { companyId: companyId, kanban: 1 };
                if (searchParam) {
            ...
            case 1:
                _b = _d.sent(), count = _b.count, tags = _b.rows;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Tag_1["default"].findOne({
                        where: { id: Number(id), companyId: companyId, kanban: 1 },
                        attributes: ["id", "name", "color", "kanban", "timeLane", "nextLaneId", "greetingMessageLane", "rollbackLaneId", "createdAt", "updatedAt"]
                    })];
            case 1:
                tag = _a.sent();
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var externalAuth, _a, name, color, timeLane, nextLaneId, greetingMessageLane, rollbackLaneId, existingTag, tag;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                externalAuth = ensureExternalAuth(req);
                _a = req.body, name = _a.name, color = _a.color, timeLane = _a.timeLane, nextLaneId = _a.nextLaneId, greetingMessageLane = _a.greetingMessageLane, rollbackLaneId = _a.rollbackLaneId;
                if (!name || !color) {
                    throw new AppError_1["default"]("ERR_TAG_NAME_COLOR_REQUIRED", 400);
                }
                return [4 /*yield*/, Tag_1["default"].findOne({
                        where: { name: name, companyId: externalAuth.companyId, kanban: 1 }
                    })];
            case 1:
                existingTag = _b.sent();
                if (existingTag) {
                ...
                return [4 /*yield*/, Tag_1["default"].create({
                        name: name,
                        color: color,
                        kanban: 1,
                        timeLane: timeLane || 0,
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var externalAuth, id, _a, name, color, timeLane, nextLaneId, greetingMessageLane, rollbackLaneId, tag, existingTag;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                externalAuth = ensureExternalAuth(req);
            ...
            case 1:
                ...
                if (!(name && name !== tag.name)) return [3 /*break*/, 3];
                return [4 /*yield*/, Tag_1["default"].findOne({
                        where: { name: name, companyId: externalAuth.companyId, kanban: 1 }
                    })];
            case 2:
                ...
                _b.label = 3;
            case 3: return [4 /*yield*/, tag.update({
