...
var ListService_1 = __importDefault(require("../../services/PartnerServices/ListService"));
var CreateService_1 = __importDefault(require("../../services/PartnerServices/CreateService"));
var ShowService_1 = __importDefault(require("../../services/PartnerServices/ShowService"));
var UpdateService_1 = __importDefault(require("../../services/PartnerServices/UpdateService"));
var DeleteService_1 = __importDefault(require("../../services/PartnerServices/DeleteService"));
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, schema, err_2, id, record;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = req.body;
...
var remove = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                Partner = _a.sent();
                return [2 /*return*/, res.status(200).json(Partner)];
        }
    });
}); };
