...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, id, service;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                companyId = ensureExternalAuth(req).companyId;
                id = req.params.id;
                return [4 /*yield*/, (0, ShowServicoService_1["default"])({ id: id, companyId: companyId })];
            case 1:
                service = _a.sent();
                return [2 /*return*/, res.json(service)];
        }
    });
}); };
exports.show = show;
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var externalAuth, data, service;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                externalAuth = ensureExternalAuth(req);
                data = req.body;
                return [4 /*yield*/, (0, CreateServicoService_1["default"])(__assign(__assign({}, data), { companyId: externalAuth.companyId }))];
            case 1:
                service = _a.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var externalAuth, id, data, service;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                externalAuth = ensureExternalAuth(req);
                id = req.params.id;
                data = req.body;
                return [4 /*yield*/, (0, UpdateServicoService_1["default"])(__assign({ id: id, companyId: externalAuth.companyId }, data))];
            case 1:
                service = _a.sent();
                return [4 /*yield*/, (0, triggerExternalWebhook_1["default"])({
                        url: externalAuth.webhookUrl,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                externalAuth = ensureExternalAuth(req);
                id = req.params.id;
                return [4 /*yield*/, (0, DeleteServicoService_1["default"])({
                        id: id,
