...
var ListService_1 = __importDefault(require("../services/CampaignSettingServices/ListService"));
var CreateService_1 = __importDefault(require("../services/CampaignSettingServices/CreateService"));
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, data, record, io;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                companyId = req.user.companyId;
                data = req.body;
                return [4 /*yield*/, (0, CreateService_1["default"])(data, companyId)];
            case 1:
                record = _a.sent();
                io = (0, socket_1.getIO)();
                io.of(String(companyId))
                    .emit("company-".concat(companyId, "-campaignSettings"), {
                    action: "create",
                    record: record
                });
