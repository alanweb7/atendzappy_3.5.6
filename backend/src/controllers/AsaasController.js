...
var secondCopyByCpf = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, cpf, data;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                companyId = req.user.companyId;
                cpf = (((_a = req.body) === null || _a === void 0 ? void 0 : _a.cpf) || ((_b = req.query) === null || _b === void 0 ? void 0 : _b.cpf) || "").toString();
                if (!companyId) {
