...
var ListService_1 = __importDefault(require("../services/ContactListItemService/ListService"));
var CreateService_1 = __importDefault(require("../services/ContactListItemService/CreateService"));
var ShowService_1 = __importDefault(require("../services/ContactListItemService/ShowService"));
var UpdateService_1 = __importDefault(require("../services/ContactListItemService/UpdateService"));
var DeleteService_1 = __importDefault(require("../services/ContactListItemService/DeleteService"));
var FindService_1 = __importDefault(require("../services/ContactListItemService/FindService"));
var AppError_1 = __importDefault(require("../errors/AppError"));
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, searchParam, pageNumber, contactListId, companyId, _b, contacts, count, hasMore;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.query, searchParam = _a.searchParam, pageNumber = _a.pageNumber, contactListId = _a.contactListId;
        ...
        switch (_a.label) {
            ...
            case 5:
                ...
                io.of(String(companyId))
                    .emit("company-".concat(companyId, "-ContactListItem"), {
                    action: "create",
                    record: record
                });
