...
export const syncTagsWithTicket = async (
  req: Request,
  res: Response
): Promise<Response> => {
  ...
  const contact = await SyncTagService({ ...data, companyId, ticketId });

  // Recarrega o ticket com tags atualizadas e emite socket para atualizar o frontend
