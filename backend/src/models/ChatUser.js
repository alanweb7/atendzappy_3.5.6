...
var ChatUser = /** @class */ (function (_super) {
    ...
    ], ChatUser.prototype, "id");
    __decorate([
        (0, sequelize_typescript_1.ForeignKey)(function () { return Chat_1["default"]; }),
        sequelize_typescript_1.Column,
        __metadata("design:type", Number)
    ], ChatUser.prototype, "chatId");
    __decorate([
        (0, sequelize_typescript_1.ForeignKey)(function () { return User_1["default"]; }),
        sequelize_typescript_1.Column,
        __metadata("design:type", Number)
    ], ChatUser.prototype, "userId");
    __decorate([
        sequelize_typescript_1.Column,
        __metadata("design:type", Number)
    ], ChatUser.prototype, "unreads");
    __decorate([
        sequelize_typescript_1.CreatedAt,
        __metadata("design:type", Date)
    ], ChatUser.prototype, "createdAt");
    __decorate([
        sequelize_typescript_1.UpdatedAt,
        __metadata("design:type", Date)
    ], ChatUser.prototype, "updatedAt");
    __decorate([
        (0, sequelize_typescript_1.BelongsTo)(function () { return Chat_1["default"]; }),
        __metadata("design:type", Chat_1["default"])
    ], ChatUser.prototype, "chat");
    __decorate([
        (0, sequelize_typescript_1.BelongsTo)(function () { return User_1["default"]; }),
        __metadata("design:type", User_1["default"])
    ], ChatUser.prototype, "user");
    ChatUser = __decorate([
