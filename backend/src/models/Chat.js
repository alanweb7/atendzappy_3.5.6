...
var ChatUser_1 = __importDefault(require("./ChatUser"));
...
var Chat = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        sequelize_typescript_1.Column,
        __metadata("design:type", Number)
    ], Chat.prototype, "ownerId");
    __decorate([
        (0, sequelize_typescript_1.Column)({ defaultValue: "" }),
        __metadata("design:type", String)
    ], Chat.prototype, "lastMessage");
    __decorate([
        (0, sequelize_typescript_1.ForeignKey)(function () { return Company_1["default"]; }),
        sequelize_typescript_1.Column,
        __metadata("design:type", Number)
    ], Chat.prototype, "companyId");
    __decorate([
    ...
    ], Chat.prototype, "company");
    __decorate([
        (0, sequelize_typescript_1.BelongsTo)(function () { return User_1["default"]; }),
        __metadata("design:type", User_1["default"])
    ], Chat.prototype, "owner");
    __decorate([
        (0, sequelize_typescript_1.HasMany)(function () { return ChatUser_1["default"]; }),
        __metadata("design:type", Array)
    ], Chat.prototype, "users");
    __decorate([
        (0, sequelize_typescript_1.HasMany)(function () { return ChatMessage_1["default"]; }),
        __metadata("design:type", Array)
