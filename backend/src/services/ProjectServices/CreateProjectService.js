...
var CreateProjectService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var schema, client, project;
        ...
        switch (_a.label) {
            case 0:
                schema = Yup.object().shape({
                    ...
                    status: Yup.string()
                        .oneOf(["draft", "active", "paused", "completed", "cancelled"])["default"]("draft")
                });
            ...
            case 2:
                ...
                return [4 /*yield*/, Project_1["default"].create(__assign(__assign({}, data), { status: data.status || "draft" }))];
            case 3:
                project = _a.sent();
