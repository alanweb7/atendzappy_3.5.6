...
var ListProjectsService = function (_a) {
    var companyId = _a.companyId, searchParam = _a.searchParam, status = _a.status, clientId = _a.clientId, _b = _a.pageNumber, pageNumber = _b === void 0 ? 1 : _b, _c = _a.limit, limit = _c === void 0 ? 20 : _c;
    return __awaiter(void 0, void 0, void 0, function () {
        var where, like, offset, _d, rows, count;
        var _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    if (searchParam) {
                        like = (_e = {}, _e[sequelize_1.Op.iLike] = "%".concat(searchParam, "%"), _e);
                ...
                case 1:
                    _d = _f.sent(), rows = _d.rows, count = _d.count;
                    return [2 /*return*/, {
                            projects: rows,
                            count: count,
