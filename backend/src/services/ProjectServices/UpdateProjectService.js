...
var UpdateProjectService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var schema, project, id, companyId, updateData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, project.update(updateData)];
            case 3:
                _a.sent();
