...
var CreateService = function (_a) {
    var mediaPath = _a.mediaPath, mediaName = _a.mediaName, mensagem = _a.mensagem, companyId = _a.companyId, data_envio = _a.data_envio, scheduledmessages = _a.scheduledmessages, key = _a.key;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, ScheduledMessagesEnvio_1["default"].create({
                            mediaPath: mediaPath,
                            mediaName: mediaName,
                            mensagem: mensagem,
                            companyId: companyId,
