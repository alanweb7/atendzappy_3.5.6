...
var UpdateFlowBuilderService = function (_a) {
    var companyId = _a.companyId, name = _a.name, flowId = _a.flowId;
    return __awaiter(void 0, void 0, void 0, function () {
        var nameExist, flow, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, FlowBuilder_1.FlowBuilderModel.update({ name: name }, {
