...
var ShowFinanceiroReceitaService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var receita;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, FinanceiroReceita_1["default"].findOne({
                    where: {
                        id: id,
                        companyId: companyId
                    },
