...
var AddCustomerToWalletService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var walletId, clientId, companyId, schema, error_1, existing, walletCustomer;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                walletId = data.walletId, clientId = data.clientId, companyId = data.companyId;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, schema.validate({ walletId: walletId, clientId: clientId, companyId: companyId })];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
            ...
            case 5:
                ...
                return [4 /*yield*/, CustomerWalletCustomer_1["default"].create({
                        walletId: walletId,
                        clientId: clientId,
                        companyId: companyId
                    })];
...
exports["default"] = AddCustomerToWalletService;
