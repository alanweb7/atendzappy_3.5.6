...
var UpdateContactWalletsService = function (_a) {
    var wallets = _a.wallets, contactId = _a.contactId, companyId = _a.companyId;
    return __awaiter(void 0, void 0, void 0, function () {
        var contactWallets, contact;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ContactWallet_1["default"].destroy({
                        where: {
                            companyId: companyId,
                            contactId: contactId
                        }
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ContactWallet_1["default"].bulkCreate(contactWallets)];
                case 2:
                    _b.sent();
