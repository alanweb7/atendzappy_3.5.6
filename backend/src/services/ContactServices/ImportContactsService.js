...
function ImportContactsService(companyId, file) {
    return __awaiter(this, void 0, void 0, function () {
        var workbook, worksheet, rows, contacts, contactList, _i, contacts_1, contact, _a, newContact, created;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    contacts = rows.map(function (row) {
                        ...
                        return { name: name, number: number, email: email, companyId: companyId };
                    });
                    contactList = [];
                ...
                case 2:
                    _a = _b.sent(), newContact = _a[0], created = _a[1];
                    if (created) {
