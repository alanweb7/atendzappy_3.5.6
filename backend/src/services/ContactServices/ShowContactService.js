...
var ShowContactService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var contact;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Contact_1["default"].findByPk(id, {
                    include: [
                        "extraInfo",
                        "tags",
                        {
            ...
            case 1:
                ...
                if (contact.companyId !== companyId) {
                    throw new AppError_1["default"]("Não é possível consultar registro de outra empresa");
                }
