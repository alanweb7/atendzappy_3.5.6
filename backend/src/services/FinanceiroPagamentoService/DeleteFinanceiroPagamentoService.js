...
var DeleteFinanceiroPagamentoService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var pagamento, fatura, io;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, FinanceiroPagamento_1["default"].findOne({
            ...
            case 1:
                ...
                return [4 /*yield*/, pagamento.destroy()];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                return [4 /*yield*/, FinanceiroFatura_1["default"].findOne({
                        where: { id: pagamento.faturaId, companyId: companyId }
                    })];
            case 4:
                fatura = _a.sent();
                io = (0, socket_1.getIO)();
