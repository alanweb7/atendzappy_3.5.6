...
var UpdateFinanceiroPagamentoService = function (_a) { return __awaiter(void 0, void 0, void 0, function () {
    var pagamento, data, fatura, io;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                data = _b.sent();
                return [4 /*yield*/, pagamento.update(data)];
            case 3:
                _b.sent();
