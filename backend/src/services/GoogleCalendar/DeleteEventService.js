...
var GetIntegrationService_1 = __importDefault(require("./GetIntegrationService"));
var googleCalendarClient_1 = require("../../helpers/googleCalendarClient");
var DeleteEventService = function (_a) {
    var schedule = _a.schedule;
    return __awaiter(void 0, void 0, void 0, function () {
        var companyId, integration, accessToken, refreshToken, expiryDate, calendarId, tokens, calendar, calendarIdToUse, googleEventId, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    err_1 = _b.sent();
                    console.error("Erro ao remover evento do Google Calendar", err_1);
                    return [3 /*break*/, 6];
