...
var ListUserQueueServices = function (queueId) { return __awaiter(void 0, void 0, void 0, function () {
    var userQueue;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, UserQueue_1["default"].findOne({
                    where: {
                        queueId: (_a = {},
                            _a[sequelize_1.Op.or] = [queueId],
                            _a)
                    },
