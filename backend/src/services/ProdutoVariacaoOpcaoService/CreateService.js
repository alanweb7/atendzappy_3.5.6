...
var CreateService = function (_a) {
    var companyId = _a.companyId, grupoId = _a.grupoId, nome = _a.nome, ordem = _a.ordem;
    return __awaiter(void 0, void 0, void 0, function () {
        var grupo, trimmedName, opcao;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ProdutoVariacaoGrupo_1["default"].findOne({ where: { id: grupoId, companyId: companyId } })];
                case 1:
                    grupo = _b.sent();
                    if (!grupo) {
                    ...
                    return [4 /*yield*/, ProdutoVariacaoOpcao_1["default"].create({
                            grupoId: grupoId,
                            nome: trimmedName,
