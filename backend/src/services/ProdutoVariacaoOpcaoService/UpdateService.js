...
var UpdateService = function (_a) {
    var companyId = _a.companyId, opcaoId = _a.opcaoId, nome = _a.nome, ordem = _a.ordem;
    return __awaiter(void 0, void 0, void 0, function () {
        var opcao, trimmedName, payload;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ProdutoVariacaoOpcao_1["default"].findByPk(opcaoId, {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, opcao.update(payload)];
                case 2:
                    _b.sent();
                    return [2 /*return*/, opcao];
            }
