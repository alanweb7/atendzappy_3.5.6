...
var FindOrCreateTicketServiceMeta = function (contact, whatsappId, unreadMessages, companyId, channel) { return __awaiter(void 0, void 0, void 0, function () {
    var ticket, msgIsGroupBlock, value;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 15:
                _c.sent();
                return [3 /*break*/, 18];
            case 16: return [4 /*yield*/, ticket.update({ whatsappId: whatsappId })];
            case 17:
                _c.sent();
                _c.label = 18;
            case 18: return [4 /*yield*/, (0, ShowTicketService_1["default"])(ticket.id, companyId)];
            case 19:
                ticket = _c.sent();
