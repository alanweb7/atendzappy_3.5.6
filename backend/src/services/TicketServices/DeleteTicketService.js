...
var DeleteTicketService = function (id, userId, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var ticket;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Message_1["default"].destroy({
                        where: { ticketId: ticket.id, companyId: companyId }
                    })];
            case 2:
                // Apagar mensagens ligadas a este ticket
                _a.sent();
            ...
            case 5:
                // Apagar notas deste ticket
                _a.sent();
                if (!ticket.contactId) return [3 /*break*/, 7];
                return [4 /*yield*/, Contact_1["default"].update({ aiMemory: null }, { where: { id: ticket.contactId, companyId: companyId } })];
            case 6:
                _a.sent();
                _a.label = 7;
            case 7: 
