...
var FindNotesByContactIdAndTicketId = function (_a) {
    var contactId = _a.contactId, ticketId = _a.ticketId;
    return __awaiter(void 0, void 0, void 0, function () {
        var notes;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, TicketNote_1["default"].findAll({
                        where: __assign(__assign({}, (contactId ? { contactId: contactId } : {})), (ticketId ? { ticketId: ticketId } : {})),
                        include: [
