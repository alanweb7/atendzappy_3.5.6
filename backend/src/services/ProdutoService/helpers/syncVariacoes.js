...
var syncVariacoes = function (produtoId, variacoes) { return __awaiter(void 0, void 0, void 0, function () {
    var payloads;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("syncVariacoes - produtoId:", produtoId, "variacoes:", variacoes);
                return [4 /*yield*/, ProdutoVariacaoItem_1["default"].destroy({ where: { produtoId: produtoId } })];
            case 1:
                _a.sent();
                ...
                payloads = variacoes.map(function (item) { return ({
                    produtoId: produtoId,
                ...
                return [4 /*yield*/, ProdutoVariacaoItem_1["default"].bulkCreate(payloads)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
