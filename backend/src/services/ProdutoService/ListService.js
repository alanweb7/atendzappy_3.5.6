...
var ListService = function (_a) {
    var companyId = _a.companyId, tipo = _a.tipo, categoriaId = _a.categoriaId;
    return __awaiter(void 0, void 0, void 0, function () {
        var whereCondition, produtos;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Produto_1["default"].findAll({
                            ...
                            include: [
                                ...
                                {
                                    model: ProdutoWhatsappSync_1["default"],
