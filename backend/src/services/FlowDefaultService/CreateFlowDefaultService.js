...
var CreateFlowDefaultService = function (_a) {
    var userId = _a.userId, companyId = _a.companyId, flowIdWelcome = _a.flowIdWelcome, flowIdPhrase = _a.flowIdPhrase;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, FlowDefault_1.FlowDefaultModel.create({
                            userId: userId,
                            companyId: companyId,
