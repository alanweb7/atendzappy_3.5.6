...
var CreateWebHookService = function (_a) {
    var userId = _a.userId, name = _a.name, companyId = _a.companyId;
    return __awaiter(void 0, void 0, void 0, function () {
        var nameExist, generateHash, webhook, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    generateHash = (0, randomCode_1.randomString)(42);
                    return [4 /*yield*/, Webhook_1.WebhookModel.create({
                            user_id: userId,
