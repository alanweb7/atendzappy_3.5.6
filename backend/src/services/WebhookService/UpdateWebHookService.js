...
var UpdateWebHookService = function (_a) {
    var userId = _a.userId, name = _a.name, companyId = _a.companyId, webhookId = _a.webhookId;
    return __awaiter(void 0, void 0, void 0, function () {
        var nameExist, webhook, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Webhook_1.WebhookModel.update({ name: name }, {
