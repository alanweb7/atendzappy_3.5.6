...
var allowedEvents = ["birthday", "invoice_reminder", "invoice_overdue"];
var UpdateScheduledDispatcherService = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    var dispatcher, schema, err_1, updates, event_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, ScheduledDispatcher_1["default"].findOne({
            ...
            case 2:
                _c.trys.push([2, 4, , 5]);
                return [4 /*yield*/, schema.validate(payload, { abortEarly: false })];
            case 3:
                _c.sent();
                return [3 /*break*/, 5];
            case 4:
            ...
            case 5:
                ...
                if (updates.eventType || payload.daysBeforeDue !== undefined || payload.daysAfterDue !== undefined) {
                    event_1 = updates.eventType || dispatcher.eventType;
                    if (event_1 === "invoice_reminder") {
                        updates.daysBeforeDue =
                            payload.daysBeforeDue !== undefined ? payload.daysBeforeDue : (_a = dispatcher.daysBeforeDue) !== null && _a !== void 0 ? _a : 0;
                        updates.daysAfterDue = null;
                    }
                    else if (event_1 === "invoice_overdue") {
                        updates.daysAfterDue =
                            payload.daysAfterDue !== undefined ? payload.daysAfterDue : (_b = dispatcher.daysAfterDue) !== null && _b !== void 0 ? _b : 0;
                ...
                return [4 /*yield*/, dispatcher.update(updates)];
            case 6:
                _c.sent();
                return [4 /*yield*/, dispatcher.reload()];
            case 7:
                _c.sent();
