...
var ShowPromptService = function (_a) {
    var promptId = _a.promptId, companyId = _a.companyId;
    return __awaiter(void 0, void 0, void 0, function () {
        var prompt, toolsEnabled;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, Prompt_1["default"].findOne({
                        where: {
                            id: promptId,
                            companyId: companyId
                        },
                ...
                case 1:
                    ...
                    toolsEnabled = ((_b = prompt.toolSettings) === null || _b === void 0 ? void 0 : _b.filter(function (tool) { return tool === null || tool === void 0 ? void 0 : tool.enabled; }).map(function (tool) { return tool.toolName; })) || [];
