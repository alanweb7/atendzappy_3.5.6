...
var DeleteEventService_1 = __importDefault(require("../GoogleCalendar/DeleteEventService"));
var DeleteService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var schedule;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("DeleteService - iniciando remoção de schedule", "id:", id, "companyId:", companyId);
                return [4 /*yield*/, Schedule_1["default"].findOne({
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, DeleteEventService_1["default"])({ schedule: schedule })];
            case 2:
                _a.sent();
