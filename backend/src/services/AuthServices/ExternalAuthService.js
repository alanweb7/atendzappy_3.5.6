...
var ExternalAuthService = function (_a) {
    var email = _a.email, password = _a.password;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, token, refreshToken, expiresIn, serializedUser;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (!user.company) return [3 /*break*/, 4];
                    return [4 /*yield*/, user.company.update({ lastLogin: new Date() })];
                case 3:
                    _c.sent();
                    _c.label = 4;
                case 4: 
                ...
                case 5:
                    ...
                    serializedUser = {
                        ...
                        queues: ((_b = user.queues) === null || _b === void 0 ? void 0 : _b.map(function (queue) { return ({
                            id: queue.id,
                            name: queue.name,
                            color: queue.color
                        }); })) || []
