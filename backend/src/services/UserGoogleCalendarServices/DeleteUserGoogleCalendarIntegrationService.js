...
var DeleteUserGoogleCalendarIntegrationService = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    var integrations, deleted;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("DEBUG - Deletando integração do usuário:", userId);
                return [4 /*yield*/, UserGoogleCalendarIntegration_1["default"].findAll({
                        where: { userId: userId }
                    })];
            case 1:
                ...
                return [4 /*yield*/, UserGoogleCalendarIntegration_1["default"].destroy({
                        where: {
                            userId: userId,
                            // Garantir que só delete integrações pessoais (sem companyId nulo)
                            companyId: (_a = {}, _a[require('sequelize').Op.ne] = null, _a)
                        }
                    })];
            case 2:
                deleted = _b.sent();
