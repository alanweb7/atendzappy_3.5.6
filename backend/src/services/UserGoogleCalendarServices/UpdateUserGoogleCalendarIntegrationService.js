...
var UpdateUserGoogleCalendarIntegrationService = function (userId, data) { return __awaiter(void 0, void 0, void 0, function () {
    var integration;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, integration.update(data)];
            case 2:
                _a.sent();
