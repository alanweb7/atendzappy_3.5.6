...
var LinkGoogleCalendarToScheduleService = function (userId, scheduleId) { return __awaiter(void 0, void 0, void 0, function () {
    var integration, schedule;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, UserGoogleCalendarIntegration_1["default"].findOne({
                    where: {
                        userId: userId,
                        active: true
                    }
...
var UnlinkGoogleCalendarFromScheduleService = function (userId, scheduleId) { return __awaiter(void 0, void 0, void 0, function () {
    var schedule;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, UserSchedule_1["default"].findOne({
                    where: {
                        id: scheduleId,
                        userId: userId
                    }
