...
var CreateService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var shortcode, message, isMedia, ticketnoteSchema, err_1, record;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                shortcode = data.shortcode, message = data.message, isMedia = data.isMedia;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ticketnoteSchema.validate({ shortcode: shortcode, message: message })];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
            ...
            case 4: return [4 /*yield*/, QuickMessage_1["default"].create(data)];
            case 5:
                record = _a.sent();
