...
var UpdateFinanceiroFornecedorService = function (_a) {
    var id = _a.id, companyId = _a.companyId, nome = _a.nome, documento = _a.documento, email = _a.email, telefone = _a.telefone, endereco = _a.endereco, numero = _a.numero, complemento = _a.complemento, bairro = _a.bairro, cidade = _a.cidade, estado = _a.estado, cep = _a.cep, categoria = _a.categoria, observacoes = _a.observacoes, ativo = _a.ativo, transaction = _a.transaction;
    return __awaiter(void 0, void 0, void 0, function () {
        var err_1, fornecedor, existingFornecedor, io;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3: return [4 /*yield*/, FinanceiroFornecedor_1["default"].findByPk(id, {
                ...
                case 4:
                    ...
                    if (!(documento !== undefined && documento !== fornecedor.documento)) return [3 /*break*/, 6];
                    if (!documento) return [3 /*break*/, 6];
                    return [4 /*yield*/, FinanceiroFornecedor_1["default"].findOne({
                            where: {
                                companyId: companyId,
                                documento: documento.trim(),
                                id: (_b = {}, _b[sequelize_1.Op.ne] = fornecedor.id, _b)
                            },
                            transaction: transaction
                        })];
                case 5:
                    ...
                    _c.label = 6;
                case 6: return [4 /*yield*/, fornecedor.update({
                        nome: (nome === null || nome === void 0 ? void 0 : nome.trim()) || fornecedor.nome,
