...
var DeleteFinanceiroFornecedorService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var fornecedor, despesasCount, io;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, FinanceiroDespesa_1["default"].count({
                        where: {
                            fornecedorId: fornecedor.id
                        }
                    })];
            case 2:
                despesasCount = _a.sent();
                if (despesasCount > 0) {
                    throw new AppError_1["default"]("Não é possível excluir fornecedor que possui despesas vinculadas.");
                }
                return [4 /*yield*/, fornecedor.destroy()];
            case 3:
                _a.sent();
                io = (0, socket_1.getIO)();
