...
var ShowFinanceiroFornecedorService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var fornecedor;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, FinanceiroFornecedor_1["default"].findByPk(id)];
            case 1:
                fornecedor = _a.sent();
                if (!fornecedor) {
