...
var findClientByContact = function (contactId, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var client, pivot;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, CrmClientContact_1["default"].findOne({
                        where: { contactId: contactId },
                        order: [["created_at", "DESC"]]
                    })];
            case 2:
                pivot = _a.sent();
                if (!pivot) return [3 /*break*/, 4];
                return [4 /*yield*/, CrmClient_1["default"].findOne({
                        where: {
                            companyId: companyId,
                            id: pivot.clientId
