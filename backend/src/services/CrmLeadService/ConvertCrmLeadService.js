...
var ConvertCrmLeadService = function (_a) {
    var leadId = _a.leadId, companyId = _a.companyId, contactId = _a.contactId, phone = _a.phone, primaryTicketId = _a.primaryTicketId;
    return __awaiter(void 0, void 0, void 0, function () {
        var lead, resolvedContactId, resolvedTicketId, client;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    resolvedTicketId = _b.sent();
                    return [4 /*yield*/, lead.update({
