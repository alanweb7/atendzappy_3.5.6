...
var syncContactToLead = function (_a) {
    var contact = _a.contact, companyId = _a.companyId;
    return __awaiter(void 0, void 0, void 0, function () {
        var lead, normalizedDocument, normalizedPhone, email, name_1, updates, normalizedDocument;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    lead = _b.sent();
                    logger_1["default"].info("Created new Lead ".concat(lead.id, " for Contact ").concat(contact.id));
                    return [3 /*break*/, 5];
                case 3:
                    updates = {};
                    normalizedDocument = normalizeDocument(contact.cpfCnpj);
                    ...
                    logger_1["default"].info("Syncing Contact ".concat(contact.id, " changes to Lead ").concat(lead.id, ":"), updates);
