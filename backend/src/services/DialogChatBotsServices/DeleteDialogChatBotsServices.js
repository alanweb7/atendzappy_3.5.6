...
var DeleteDialogChatBotsServices = function (contactId) { return __awaiter(void 0, void 0, void 0, function () {
    var queue;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, DialogChatBots_1["default"].findOne({
                    where: {
                        contactId: contactId
                    }
                })];
