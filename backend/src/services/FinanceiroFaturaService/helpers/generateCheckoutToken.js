...
var generateCheckoutToken = function () { return __awaiter(void 0, void 0, void 0, function () {
    var token, exists, count;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, FinanceiroFatura_1["default"].count({ where: { checkoutToken: token } })];
            case 2:
                count = _a.sent();
                exists = count > 0;
                _a.label = 3;
