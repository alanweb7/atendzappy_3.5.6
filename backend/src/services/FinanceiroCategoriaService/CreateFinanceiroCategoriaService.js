...
var CreateFinanceiroCategoriaService = function (_a) {
    var companyId = _a.companyId, nome = _a.nome, tipo = _a.tipo, paiId = _a.paiId, _b = _a.cor, cor = _b === void 0 ? "#6B7280" : _b, _c = _a.ativo, ativo = _c === void 0 ? true : _c, transaction = _a.transaction;
    return __awaiter(void 0, void 0, void 0, function () {
        var err_1, existingCategoria, categoriaPai, categoria, io;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3: return [4 /*yield*/, FinanceiroCategoria_1["default"].findOne({
                        where: {
                            companyId: companyId,
                            nome: nome.trim(),
                            tipo: tipo
                ...
                case 5:
                    ...
                    _d.label = 6;
                case 6: return [4 /*yield*/, FinanceiroCategoria_1["default"].create({
                        companyId: companyId,
                        nome: nome.trim(),
                        tipo: tipo,
                        paiId: paiId,
