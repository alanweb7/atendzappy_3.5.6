...
var ShowFinanceiroCategoriaService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var categoria;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, FinanceiroCategoria_1["default"].findByPk(id, {
                    include: [
                        {
