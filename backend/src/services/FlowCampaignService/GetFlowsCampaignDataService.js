...
var GetFlowsCampaignDataService = function (_a) {
    var companyId = _a.companyId, idFlow = _a.idFlow;
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, count, rows, hook, anyHook, rawPhrases, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, FlowCampaign_1.FlowCampaignModel.findAndCountAll({
                            where: {
                                id: idFlow
                            }
                        })];
