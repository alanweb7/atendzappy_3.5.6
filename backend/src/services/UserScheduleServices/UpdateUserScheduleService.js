...
var UpdateUserScheduleService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4: return [4 /*yield*/, UserSchedule_1["default"].findOne({
            ...
            case 5:
                ...
                return [4 /*yield*/, schedule.update({
                        name: (_a = data.name) !== null && _a !== void 0 ? _a : schedule.name,
