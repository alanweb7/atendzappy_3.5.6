...
var UpdateService = function (_a) {
    var companyId = _a.companyId, grupoId = _a.grupoId, nome = _a.nome;
    return __awaiter(void 0, void 0, void 0, function () {
        var trimmedName, grupo, duplicated;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    trimmedName = nome === null || nome === void 0 ? void 0 : nome.trim();
                    if (!trimmedName) {
                        throw new AppError_1["default"]("ERR_PRODUTO_VARIACAO_GRUPO_INVALID_NAME", 400);
                    }
                    return [4 /*yield*/, ProdutoVariacaoGrupo_1["default"].findOne({ where: { id: grupoId, companyId: companyId } })];
                case 1:
                    grupo = _c.sent();
                    if (!grupo) {
                        throw new AppError_1["default"]("ERR_PRODUTO_VARIACAO_GRUPO_NOT_FOUND", 404);
                    }
                    return [4 /*yield*/, ProdutoVariacaoGrupo_1["default"].findOne({
                            where: {
                                companyId: companyId,
                                nome: trimmedName,
                                id: (_b = {},
                                    _b[sequelize_1.Op.ne] = grupoId,
                                    _b)
                            }
                        })];
                case 2:
                    ...
                    return [4 /*yield*/, grupo.update({ nome: trimmedName })];
                case 3:
                    _c.sent();
