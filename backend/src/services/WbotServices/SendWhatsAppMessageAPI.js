...
var SendWhatsAppMessage = function (_a) {
    var body = _a.body, whatsappId = _a.whatsappId, contact = _a.contact, quotedMsg = _a.quotedMsg, msdelay = _a.msdelay;
    return __awaiter(void 0, void 0, void 0, function () {
        var options, wbot, number, chatMessages, msgFound, sentMessage, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    options = {};
                    return [4 /*yield*/, (0, wbot_1.getWbot)(whatsappId)];
                case 1:
                    wbot = _b.sent();
                    number = "".concat(contact.number, "@").concat(contact.isGroup ? "g.us" : "s.whatsapp.net");
                    if (!quotedMsg) return [3 /*break*/, 3];
