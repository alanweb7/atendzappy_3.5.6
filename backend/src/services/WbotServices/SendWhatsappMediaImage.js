...
var SendWhatsAppMediaImage = function (_a) {
    var ticket = _a.ticket, url = _a.url, caption = _a.caption, msdelay = _a.msdelay;
    return __awaiter(void 0, void 0, void 0, function () {
        var wbot, contactNumber, number, sentMessage, err_1;
            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, wbot.sendMessage("".concat(number), {
                            image: url ? { url: url } : { url: "".concat(publicFolder, "/company").concat(ticket.companyId, "/").concat(caption, "-").concat(makeid(5), ".png") },
                            caption: (0, Mustache_1["default"])("".concat(caption), ticket),
                            mimetype: 'image/jpeg'
                        })];
                case 5:
                    sentMessage = _b.sent();
