...
var CheckIsValidContact = function (number, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var defaultWhatsapp, wbot, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, wbot.onWhatsApp("".concat(number, "@s.whatsapp.net"))];
            case 3:
                result = (_a.sent())[0];
                if (!result && !(result === null || result === void 0 ? void 0 : result.exists)) {
            ...
            case 4:
                err_1 = _a.sent();
                console.log(err_1);
                if (err_1.message === "invalidNumber") {
