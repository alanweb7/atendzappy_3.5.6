...
var CreateService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var title, description, helpSchema, err_1, record;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                title = data.title, description = data.description;
                helpSchema = Yup.object().shape({
                    title: Yup.string()
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, helpSchema.validate({ title: title, description: description })];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
            ...
            case 4: return [4 /*yield*/, Help_1["default"].create(data)];
            case 5:
                record = _a.sent();
