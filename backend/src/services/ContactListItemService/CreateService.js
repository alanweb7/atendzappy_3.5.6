...
var CheckNumber_1 = __importDefault(require("../WbotServices/CheckNumber"));
var CreateService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var name, contactListItemSchema, err_1, record, response, number, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                name = data.name;
                contactListItemSchema = Yup.object().shape({
                    name: Yup.string()
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, contactListItemSchema.validate({ name: name })];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
            ...
            case 4: return [4 /*yield*/, ContactListItem_1["default"].findOrCreate({
                    where: {
                        number: data.number,
            ...
            case 9:
                e_1 = _a.sent();
                logger_1["default"].error("N\u00FAmero de contato inv\u00E1lido: ".concat(record.number));
                return [3 /*break*/, 10];
