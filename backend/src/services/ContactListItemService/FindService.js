...
var FindService = function (_a) {
    var companyId = _a.companyId, contactListId = _a.contactListId;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (contactListId) {
                        where = __assign(__assign({}, where), { contactListId: contactListId });
                    }
                    return [4 /*yield*/, ContactListItem_1["default"].findAll({
                            where: where,
