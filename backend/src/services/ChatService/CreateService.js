...
var CreateService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var ownerId, companyId, users, title, record, _i, users_1, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ownerId = data.ownerId, companyId = data.companyId, users = data.users, title = data.title;
            ...
            case 5:
                _i++;
                return [3 /*break*/, 3];
            case 6: return [4 /*yield*/, record.reload({
                    include: [
