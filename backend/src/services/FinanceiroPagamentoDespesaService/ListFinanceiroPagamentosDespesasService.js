...
var ListFinanceiroPagamentosDespesasService = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var whereConditions, limit, offset, _a, count, pagamentos, hasMore, err_1;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if (params.searchParam) {
                    whereConditions[sequelize_1.Op.or] = [
                        { observacoes: (_b = {}, _b[sequelize_1.Op.like] = "%".concat(params.searchParam, "%"), _b) },
                        { metodoPagamento: (_c = {}, _c[sequelize_1.Op.like] = "%".concat(params.searchParam, "%"), _c) }
                    ];
                }
                if (params.despesaId) {
                ...
                limit = 20;
                offset = params.pageNumber ? (params.pageNumber - 1) * limit : 0;
                return [4 /*yield*/, FinanceiroPagamentoDespesa_1["default"].findAndCountAll({
            ...
            case 1:
                _a = _d.sent(), count = _a.count, pagamentos = _a.rows;
                hasMore = count > offset + pagamentos.length;
                return [2 /*return*/, {
            ...
            case 2:
                err_1 = _d.sent();
                console.error("Erro ao listar pagamentos de despesas:", err_1);
