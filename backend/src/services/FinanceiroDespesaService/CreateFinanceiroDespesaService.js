    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    if (!fornecedorId) return [3 /*break*/, 5];
                ...
                case 4:
                    ...
                    _f.label = 5;
                case 5:
                    if (!categoriaId) return [3 /*break*/, 7];
                ...
                case 7:
                    ...
                    return [4 /*yield*/, FinanceiroDespesa_1["default"].create({
                            companyId: companyId,
                            fornecedorId: fornecedorId,
                            categoriaId: categoriaId,
                ...
                case 8:
                    despesa = _f.sent();
                    io = (0, socket_1.getIO)();
                    io.to("company-".concat(companyId)).emit("financeiro_despesa", {
                        action: "create",
                        data: despesa
                    });
