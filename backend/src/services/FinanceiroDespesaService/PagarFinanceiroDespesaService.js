...
var PagarFinanceiroDespesaService = function (id, companyId, data) { return __awaiter(void 0, void 0, void 0, function () {
    var record, io, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, FinanceiroDespesa_1["default"].findOne({
                        where: {
                            id: id,
                            companyId: companyId
                        }
            ...
            case 2:
                ...
                io.to("company-".concat(companyId, "-financeiro")).emit("financeiroDespesa", {
                    action: "pagar",
                    record: record
                });
            ...
            case 3:
                err_1 = _a.sent();
                console.error("Erro ao pagar despesa:", err_1);
