...
var ListPublicPlansSimpleService = function () { return __awaiter(void 0, void 0, void 0, function () {
    var plans;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Plan_1["default"].findAll({
                    where: { isPublic: true },
                    attributes: [
            ...
            case 1:
                plans = _a.sent();
                return [2 /*return*/, plans.map(function (plan) { return plan.get({ plain: true }); })];
        }
    });
}); };
