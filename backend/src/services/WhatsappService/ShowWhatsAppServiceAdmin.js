...
var ShowWhatsAppServiceAdmin = function (id, session) { return __awaiter(void 0, void 0, void 0, function () {
    var findOptions, whatsapp, prompt, toolsEnabled;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Whatsapp_1["default"].findByPk(id, findOptions)];
            case 1:
                whatsapp = _a.sent();
                prompt = whatsapp === null || whatsapp === void 0 ? void 0 : whatsapp.prompt;
                if (prompt === null || prompt === void 0 ? void 0 : prompt.toolSettings) {
                    toolsEnabled = prompt.toolSettings
                        .filter(function (tool) { return tool === null || tool === void 0 ? void 0 : tool.enabled; })
                        .map(function (tool) { return tool.toolName; }) || [];
