...
var ListWhatsAppsService = function (_a) {
    var session = _a.session, companyId = _a.companyId;
    return __awaiter(void 0, void 0, void 0, function () {
        var options, whatsapps;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    whatsapps.forEach(function (whatsapp) {
                        var prompt = whatsapp === null || whatsapp === void 0 ? void 0 : whatsapp.prompt;
                        if (prompt === null || prompt === void 0 ? void 0 : prompt.toolSettings) {
                            var toolsEnabled = prompt.toolSettings
