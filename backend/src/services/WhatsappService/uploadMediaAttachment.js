...
var mediaUpload = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.sent();
                return [2 /*return*/, res.status(200).json({ mensagem: "Arquivo adicionado!" })];
            case 4:
                err_1 = _a.sent();
...
var deleteMedia = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var whatsappId, whatsapp, filePath, fileExists, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                whatsappId = req.params.whatsappId;
            ...
            case 3:
                _a.sent();
                return [2 /*return*/, res.send({ message: "Arquivo excluído" })];
            case 4:
                err_2 = _a.sent();
