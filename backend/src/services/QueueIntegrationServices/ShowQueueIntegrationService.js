...
var ShowQueueIntegrationService = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var integration;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, QueueIntegrations_1["default"].findByPk(id)];
            case 1:
                integration = _a.sent();
