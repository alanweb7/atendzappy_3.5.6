...
var StatisticsPerUser = function (_a) {
    var startDate = _a.startDate, endDate = _a.endDate, companyId = _a.companyId;
    return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, database_1["default"].query(query, {
                        replacements: {
                            companyId: companyId,
                            startDate: startDate,
                            endDate: endDate
