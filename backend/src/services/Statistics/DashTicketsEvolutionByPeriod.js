...
var DashTicketsEvolutionByPeriod = function (_a) {
    var startDate = _a.startDate, endDate = _a.endDate, companyId = _a.companyId, userId = _a.userId, userProfile = _a.userProfile;
