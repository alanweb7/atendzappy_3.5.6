...
exports.AI_TOOL_CATALOG = [
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Lista todas as ferramentas/APIs configuradas e ativas disponíveis para uso.",
        whenToUse: "Use antes de executar qualquer ferramenta para saber quais ferramentas estão disponíveis e quais placeholders cada uma requer.",
        howToUse: "Chame list_available_tools sem parâmetros. Retorna lista com nome, descrição e placeholders de cada ferramenta ativa.",
        openaiParameters: {
            type: "object",
            properties: {},
            required: [],
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: true,
        description: "Executa uma ferramenta/API pré-configurada. IMPORTANTE: Após receber a resposta da API, você DEVE interpretar o resultado e responder ao usuário de forma natural. NUNCA mostre JSON cru.",
        whenToUse: "Use list_available_tools primeiro para ver ferramentas disponíveis, depois execute_tool com os placeholders necessários. SEMPRE interprete a resposta antes de enviar ao usuário.",
        howToUse: "1) Liste ferramentas disponíveis 2) Execute com placeholders 3) INTERPRETE a resposta e responda naturalmente ao usuário",
        openaiParameters: {
            type: "object",
            properties: {
                ferramentaNome: {
    ...
    },
    {
        ...
        whenToUse: "Use quando precisar mostrar quais agendas/profissionais estão disponíveis para agendamento.",
    ...
    },
    {
        ...
        whenToUse: "Use quando precisar ver os compromissos já agendados de um profissional em um dia específico.",
    ...
    },
    {
        ...
        whenToUse: "Use quando o cliente perguntar quais horários estão livres para agendamento.",
    ...
    },
    {
        ...
        whenToUse: "Use quando o cliente quiser agendar um compromisso/consulta com um profissional.",
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: true,
        description: "Executa comandos administrativos no formato #{ } para alterar fila/usuário/tag/fechar atendimento/enviar resposta rápida.",
        whenToUse: "Use apenas quando as instruções personalizadas pedirem execução por IDs ou comandos administrativos.",
        howToUse: "Chame execute_command com command #{ \"queueId\":\"ID\", \"userId\":\"ID\", \"tagId\":\"ID\", \"closeTicket\":\"1\", \"resp\":\"ID\" } (ou parâmetros diretos se aplicável). resp é o ID da resposta rápida (QuickMessage).",
        openaiParameters: {
            type: "object",
            properties: {
                command: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Pausa o bot/automação por um período determinado de minutos, permitindo que apenas atendentes humanos respondam.",
        whenToUse: "Use quando o cliente solicitar falar com humano ou quando a situação exigir intervenção manual.",
        howToUse: "Chame pause_bot com pauseBot (número de minutos). Padrão: 30 minutos.",
        openaiParameters: {
            type: "object",
            properties: {
                pauseBot: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Envia uma localização geográfica (latitude, longitude e nome) para o cliente via WhatsApp.",
        whenToUse: "Use quando precisar enviar endereço, localização de loja, ponto de encontro ou qualquer coordenada geográfica.",
        howToUse: "Chame send_location com sendLocation no formato 'latitude,longitude,nome' (ex: '-23.550520,-46.633308,Av Paulista').",
        openaiParameters: {
            type: "object",
            properties: {
                sendLocation: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: true,
        description: "Redireciona o fluxo atual do FlowBuilder para um nó específico, permitindo pular etapas ou voltar a pontos anteriores.",
        whenToUse: "Use apenas dentro de fluxos FlowBuilder quando precisar mudar dinamicamente o caminho do fluxo baseado em condições.",
        howToUse: "Chame jump_to_node com jumpToNode (ID do nó de destino).",
        openaiParameters: {
            type: "object",
            properties: {
                jumpToNode: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Envia uma notificação em tempo real para um atendente específico sobre o ticket atual.",
        whenToUse: "Use quando precisar alertar um atendente sobre situação urgente, cliente VIP ou qualquer evento que exija atenção imediata.",
        howToUse: "Chame notify_user com notifyUser (ID do usuário) e notifyMessage (mensagem da notificação).",
        openaiParameters: {
            type: "object",
            properties: {
                notifyUser: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Valida CPF ou CNPJ usando algoritmo oficial, retornando se é válido e a versão formatada.",
        whenToUse: "Use quando precisar validar documento do cliente antes de prosseguir com cadastro, compra ou qualquer operação que exija CPF/CNPJ válido.",
        howToUse: "Chame validate_cpf com validateCPF (CPF ou CNPJ com ou sem formatação).",
        openaiParameters: {
            type: "object",
            properties: {
                validateCPF: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Valida formato de email usando regex padrão, retornando se é válido.",
        whenToUse: "Use quando precisar validar email do cliente antes de cadastro, envio de documentos ou qualquer operação que exija email válido.",
        howToUse: "Chame validate_email com validateEmail (endereço de email).",
        openaiParameters: {
            type: "object",
            properties: {
                validateEmail: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Valida telefone brasileiro (DDD + número), retornando se é válido, versão formatada e DDD.",
        whenToUse: "Use quando precisar validar telefone do cliente antes de cadastro, contato ou qualquer operação que exija telefone válido.",
        howToUse: "Chame validate_phone com validatePhone (telefone com ou sem formatação).",
        openaiParameters: {
            type: "object",
            properties: {
                validatePhone: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Agenda uma mensagem para ser enviada em data/hora futura específica (funcionalidade em desenvolvimento).",
        whenToUse: "Use quando cliente solicitar lembrete, follow-up ou mensagem agendada para momento futuro.",
        howToUse: "Chame schedule_message com scheduleMessage (data/hora ISO) e messageText (conteúdo da mensagem).",
        openaiParameters: {
            type: "object",
            properties: {
                scheduleMessage: {
    ...
    },
    {
        ...
        providers: ["openai", "gemini"],
        sensitive: false,
        description: "Consulta o conteúdo completo de uma base de conhecimento pelo nome. Use quando precisar de informações específicas que estão em uma das bases disponíveis.",
        whenToUse: "Use quando a pergunta do usuário exigir informações que estão em uma base de conhecimento específica. Não use se já souber a resposta.",
        howToUse: "Chame consultar_base_conhecimento com o campo nome_base sendo o nome exato da base listada no índice.",
        openaiParameters: {
            type: "object",
            properties: {
                nome_base: {
