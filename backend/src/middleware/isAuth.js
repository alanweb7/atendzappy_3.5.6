...
var updateUser_1 = require("../helpers/updateUser");
var isAuth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, _a, token, decoded, _b, id, profile, companyId, user, err_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                console.error("Auth error:", err_1.name, err_1.message);
                if (err_1.name === "TokenExpiredError") {
                    throw new AppError_1["default"]("ERR_SESSION_EXPIRED", 401);
                }
                else if (err_1.name === "JsonWebTokenError") {
