...
var isAuthCompany = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, _a, token, getToken;
    return __generator(this, function (_b) {
        ...
        try {
            getToken = process.env.COMPANY_TOKEN;
            if (!getToken) {
                throw new AppError_1["default"]("ERR_SESSION_EXPIRED", 401);
            }
            if (getToken !== token) {
