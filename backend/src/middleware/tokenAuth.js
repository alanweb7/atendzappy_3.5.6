...
var isAuthApi = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, _a, token, whatsapp, getToken, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                whatsapp = _b.sent();
                getToken = whatsapp === null || whatsapp === void 0 ? void 0 : whatsapp.token;
                if (!getToken) {
                    throw new AppError_1["default"]("ERR_SESSION_EXPIRED", 401);
                }
                if (getToken !== token) {
