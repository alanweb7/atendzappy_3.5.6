...
var setChannelWebhook_1 = require("../helpers/setChannelWebhook");
var CreateChannelsService_1 = __importDefault(require("../services/CreateChannelsService"));
var ListChannels_1 = __importDefault(require("../services/ListChannels"));
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, channels, companyId, whatsapps, io;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body.channels, channels = _a === void 0 ? [] : _a;
                companyId = req.user.companyId;
                return [4 /*yield*/, (0, CreateChannelsService_1["default"])({
                        companyId: companyId,
                        channels: channels
                    })];
            case 1:
                whatsapps = (_b.sent()).whatsapps;
...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var companyId, channels, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, ListChannels_1["default"])(companyId.toString())];
            case 2:
                channels = _a.sent();
                return [2 /*return*/, res.status(200).json(channels)];
            case 3:
                error_1 = _a.sent();
