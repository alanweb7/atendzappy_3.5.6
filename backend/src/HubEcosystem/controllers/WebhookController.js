...
var HubMessageListener_1 = __importDefault(require("../services/HubMessageListener"));
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        console.log('aaa', req.body, req.params);
        return [2 /*return*/, res.send(req.query["hub.challenge"])];
    });
}); };
exports.index = index;
var listen = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var medias, channelId, connection, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                medias = req.files;
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, (0, HubMessageListener_1["default"])(req.body, connection, medias)];
            case 3:
                _a.sent();
                return [2 /*return*/, res.status(200).json({ message: "Webhook received" })];
            case 4:
                error_1 = _a.sent();
