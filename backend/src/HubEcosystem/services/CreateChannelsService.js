...
var CreateChannelsService = function (_a) {
    var companyId = _a.companyId, _b = _a.channels, channels = _b === void 0 ? [] : _b;
    return __awaiter(void 0, void 0, void 0, function () {
        var company, whatsappCount, whatsapps;
            ...
            switch (_c.label) {
                ...
                case 3:
                    channels = channels.map(function (channel) {
                        return __assign(__assign({}, channel), { status: "CONNECTED", companyId: companyId, notificameHub: true });
                    });
                    return [4 /*yield*/, Whatsapp_1["default"].bulkCreate(channels, {
                            include: ["queues"]
                        })];
                case 4:
                    whatsapps = _c.sent();
                    return [2 /*return*/, { whatsapps: whatsapps }];
            }
        });
    });
};
